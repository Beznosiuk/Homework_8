...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSorted by area of shape:");
        Arrays.sort(figures, new CompareByArea());
        showShapes(figures);

        System.out.println("\nSorted by color of shape:");
        Arrays.sort(figures, new CompareByColor());
        showShapes(figures);

    }


    private static Shape[] figures() {
        ...
        return new Shape[]{rectangle1, rectangle2, rectangle3, rectangle4,
